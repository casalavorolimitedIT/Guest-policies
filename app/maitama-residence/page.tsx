...
const sections = [
  {
    ...
    items: [
      ...
      "A caution deposit of ₦50,000 is required before check-in. This deposit will cover incidental charges and any damages during the stay.",
    ],
  },
  {
    number: "02",
  ...
  },
  {
    ...
    items: [
      "The Residence is a non-smoking property except in designated areas (Balcony or pool side).",
      "Smoking inside guest rooms will attract a penalty of ₦150,000 and eviction.",
  ...
  },
  {
    ...
    items: [
      ...
      "The caution deposit of ₦50,000 collected before check-in may be applied toward damages or other incidental charges.",
  ...
  },
  {
    ...
    items: [
      "Guests are advised to secure valuables.",
    ...
    <div className="min-h-screen bg-[#0c0c0c] text-white">
      <div className="border-b border-white/6 px-6 py-16 text-center">
        ...
        <p className="text-zinc-500 text-base mt-5 max-w-sm mx-auto leading-relaxed">
          ...
          <span className="text-zinc-300"> The Maitama Residence</span>, you agree
      ...
      <div className="border-t border-white/5 py-10 text-center">
        <p className="text-[11px] text-zinc-700 tracking-widest uppercase">
          The Maitama Residence &mdash; Guest Policies
        </p>
